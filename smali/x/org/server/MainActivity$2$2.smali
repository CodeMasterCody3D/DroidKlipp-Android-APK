.class Lx/org/server/MainActivity$2$2;
...
.method constructor <init>(Lx/org/server/MainActivity$2;Landroid/graphics/Rect;II)V
    ...
    .line 587
    iput-object p1, p0, Lx/org/server/MainActivity$2$2;->this$1:Lx/org/server/MainActivity$2;

    iput-object p2, p0, Lx/org/server/MainActivity$2$2;->val$r:Landroid/graphics/Rect;

    iput p3, p0, Lx/org/server/MainActivity$2$2;->val$widthDiff:I

    iput p4, p0, Lx/org/server/MainActivity$2$2;->val$heightDiff:I
...
.method public run()V
    ...
    .line 590
    iget-object v0, p0, Lx/org/server/MainActivity$2$2;->this$1:Lx/org/server/MainActivity$2;
    ...
    iget-object v1, p0, Lx/org/server/MainActivity$2$2;->this$1:Lx/org/server/MainActivity$2;
    ...
    iget-object v0, p0, Lx/org/server/MainActivity$2$2;->val$r:Landroid/graphics/Rect;

    iget v0, v0, Landroid/graphics/Rect;->left:I

    iget v1, p0, Lx/org/server/MainActivity$2$2;->val$widthDiff:I

    add-int/2addr v0, v1

    iget-object v1, p0, Lx/org/server/MainActivity$2$2;->val$r:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->top:I

    iget v2, p0, Lx/org/server/MainActivity$2$2;->val$heightDiff:I

    add-int/2addr v1, v2

    iget-object v2, p0, Lx/org/server/MainActivity$2$2;->val$r:Landroid/graphics/Rect;

    invoke-virtual {v2}, Landroid/graphics/Rect;->width()I

    move-result v2

    iget-object v3, p0, Lx/org/server/MainActivity$2$2;->val$r:Landroid/graphics/Rect;
