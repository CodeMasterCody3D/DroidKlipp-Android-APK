...
.method private final hasNextSuspend(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 861
    iget-object v5, p0, Lkotlinx/coroutines/channels/AbstractChannel$Itr;->channel:Lkotlinx/coroutines/channels/AbstractChannel;

    if-eqz v3, :cond_1

    .line 857
    invoke-static {v5, v1, v4}, Lkotlinx/coroutines/channels/AbstractChannel;->access$removeReceiveOnCancel(Lkotlinx/coroutines/channels/AbstractChannel;Lkotlinx/coroutines/CancellableContinuation;Lkotlinx/coroutines/channels/Receive;)V

    goto :goto_1

    .line 861
    :cond_1
    invoke-virtual {v5}, Lkotlinx/coroutines/channels/AbstractChannel;->pollInternal()Ljava/lang/Object;
